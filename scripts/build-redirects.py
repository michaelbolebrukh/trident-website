...
PAGE_MAP = {
    ...
    # purpose: they need no rule. /london/, /self-build-modular-homes/,
    # /commercial/ and /eco-modular-homes/ are served again since September
    # 2026 and must not be listed here. Keeping the URL beats redirecting to a
