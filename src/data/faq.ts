...
export const faqs: Faq[] = [
  ...
  { q: 'Is a Trident modular home the same as a mobile home or static caravan?', a: 'No. A mobile home or static caravan is built as a towable unit on its own chassis. A Trident building is a closed-panel timber-frame house made in the factory and assembled on a prepared foundation on your plot as a permanent building, with BOPAS accreditation, the assessment lenders use for offsite-built homes.', cat: 'Choosing a Home' },
  { q: 'Do you supply mobile homes, park homes or static caravans?', a: 'No. Trident supplies factory-built modular homes, garden rooms and commercial buildings: timber-frame panels manufactured to ISO 9001:2015 and assembled on site into a permanent structure.', cat: 'Choosing a Home' },
  { q: 'Can a Trident building be relocated later?', a: 'Garden buildings sit on a ground screw foundation and arrive as a factory kit or an erected shell, so relocation is a question we can answer for a specific model. A house on its foundation with services connected is designed as a permanent home. Ask us before planning a move.', cat: 'Choosing a Home' },
