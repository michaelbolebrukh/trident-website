...
const faqs = [
  { q: 'What is the difference between a modular home and a frame-built home?', a: 'Modular homes are manufactured in sections (modules) in a factory and assembled on site. Frame-built homes use a structural timber frame constructed or assembled on site. Both offer excellent insulation and can be highly customised.', cat: 'Choosing a Home' },
  ...
  { q: 'What is the smallest building you supply?', a: 'Our smallest garden rooms start from approximately 15m². We also supply larger annexes and full residential homes from 68m² upwards.', cat: 'Choosing a Home' },
  { q: 'How do I get a price?', a: 'You can request a quotation through our contact page or by telephone. Catalogue prices shown are starting figures — actual costs depend on your specification, site conditions and completion option chosen.', cat: 'Pricing & Quotes' },
  { q: 'Are the prices shown on the website inclusive of VAT?', a: 'Prices shown are exclusive of VAT. VAT treatment can vary depending on the nature of the project and site. We will clarify this at quotation stage.', cat: 'Pricing & Quotes' },
  { q: 'Is finance available?', a: 'We do not arrange finance directly, but can recommend specialist providers for self-build and garden room finance. Please ask at quotation stage.', cat: 'Pricing & Quotes' },
  ...
  { q: 'Do residential homes require full planning permission?', a: 'Yes. Permanent residential dwellings require planning permission. We can provide planning support and work with your architect or planning consultant if required.', cat: 'Planning & Permissions' },
  { q: 'How long does installation take?', a: 'Structural assembly for a modular home typically takes between 3 and 10 days depending on the model. Internal completion under a turnkey contract takes longer and depends on the specification agreed.', cat: 'Installation' },
  { q: 'Do I need to prepare a foundation before you deliver?', a: 'Yes. Foundations are required before delivery. For Base contracts, the client is responsible for groundworks. For Turnkey contracts, we can include foundation and groundworks within the scope.', cat: 'Installation' },
  ...
  { q: 'What insulation values do your buildings achieve?', a: 'Our standard wall construction achieves a U-value of approximately 0.18 W/m²K. Roofs achieve approximately 0.12 W/m²K. Floors achieve approximately 0.13 W/m²K. Enhanced specifications are available.', cat: 'Technical' },
  { q: 'Are your buildings suitable for year-round use?', a: 'Yes. All Trident buildings are designed for year-round habitation with full insulation, heating and ventilation. Garden rooms are equally suitable as permanent workspaces or annexes.', cat: 'Technical' },
  { q: 'How far do you deliver?', a: 'We deliver UK-wide. Delivery logistics are assessed at quotation stage, and we will confirm crane requirements, vehicle access and any restrictions specific to your site.', cat: 'Delivery' },
  { q: 'How long does delivery take after I place an order?', a: 'Lead times vary depending on current production schedule and specification. Typical lead times from order to delivery are 12–20 weeks. We will confirm an indicative programme at quotation stage.', cat: 'Delivery' },
